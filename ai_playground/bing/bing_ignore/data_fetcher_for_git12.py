...
def main():
    ...
    result = ai_assistant.call_assistant("Provide a comprehensive analysis of the artwork 'Starry Night'")
    
    if result:
        print("🎨 예술 작품 분석 결과:")
        print(f"사용자 요청: {result['user_message']}")
        print(f"어시스턴트 응답: {result['assistant_response']}")
    else:
        print("분석 실패")
