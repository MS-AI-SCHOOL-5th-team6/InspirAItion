...
# 환경 변수에서 API 키 가져오기
#openAI_api_key = os.getenv('AZURE_OPENAI_API_KEY', '883MBnccg0TLFV7MEZNVqmFRwmEiEBx0SbBiivVnEIefJgVkW4JTJQQJ99BBACHYHv6XJ3w3AAAAACOGmcwh')
...
class AsyncCurationClient:
    async def __aenter__(self):
        ...
        self.gpt_client = AzureAIAssistant(initialize_azure_openai_client())  # GPT 클라이언트 초기화
