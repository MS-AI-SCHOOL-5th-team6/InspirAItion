...
class CurationRequest:
    user_prompt: str
    selected_style: Enum  # CurationStyle Enum 인스턴스
...
class EnhancedCurationService:
    def __init__(self, met_client: MetMuseumClient, gpt_client: AzureAIAssistant, session: aiohttp.ClientSession):
...
async def main():
    image_analysis = ImageAnalysis(
        dense_caption="A beautiful painting",
        tags=["impressionism"],
